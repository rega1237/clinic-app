...
urlpatterns = [
    ...
    path(
        "profile/", DoctorCRUDView.as_view(), name="doctor-profile"
    ),  # Create, update and delete doctor profile
    path(
        "specializations/all/", AllSpecializations.as_view(), name="specializations"
    ),  # Get all the specializations
    path(
        "specialization/<int:pk>/",
        SpecializationShowDelete.as_view(),
        name="specialization",
    ),  # Get specific specialization
    path(
        "specialization/create/",
        SpecializationCreate.as_view(),
